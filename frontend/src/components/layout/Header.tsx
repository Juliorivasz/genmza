...
export function Header() {
  return (
    <header className="sticky top-0 z-40 w-full">
      <div className="backdrop-blur-xl bg-zinc-950/80 border-b border-white/5">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 lg:px-10">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="hidden text-xs text-zinc-600 lg:block leading-none mt-0.5">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <div className="flex items-center gap-1 text-xs text-amber-400">
              ...
              <span className="ml-1 text-zinc-400">4.9 · 200+ reseñas</span>
            </div>
          </div>

          {/* ── Mobile tagline ── */}
          <span className="text-xs text-zinc-600 sm:block lg:hidden">
            Presupuesto gratis
          </span>
        </div>
      </div>
